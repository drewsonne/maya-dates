...
export class Tzolkin extends CommentWrapper implements IPart {
   ...
   * 
   * @param {number} dayNumber - Days since epoch (MDN), can be negative for dates before epoch
   * @return {Tzolkin}
   */
   ...
   * 
   * @param {Number} newIncremental - Number of days to shift (positive for forward, negative for backward)
   * @return {Tzolkin}
   */
