 ...
 *
 * Common modern variant spellings (Pop, Ik', Ak'bal)
 *
 ...
 */
export const modernVariantLocale: LocaleDefinition = {
  locale: 'modern-variant',
  ...
  tzolkinDays: {
    ...
    // Day 7: manik
    // Locale spelling: Manik' (sources: MARTIN2012_PENN)
    // Alternatives:
    //   - Manik (sources: ALDANA2022_EHOS, THOMPSON1950_MESOWEB, MAA_MAYATIMECYCLES_PDF)
    'Manik\'': {
      canonical: 'Manik\'',
      alternatives: ['Manik']
    },
    ...
    // Day 18: etznab
    // Locale spelling: Edznab (sources: STUART_EDZNAB_POST, TAUBE_WORKS_PDF)
    // Alternatives:
    //   - Etz'nab (sources: ALDANA2022_EHOS, MARTIN2012_PENN, THOMPSON1950_MESOWEB, MAA_MAYATIMECYCLES_PDF)
    'Etz\'nab': {
      canonical: 'Edznab',
      alternatives: ['Etz\'nab']
    },
    // Day 19: kawak
    ...
    // Day 20: ajaw
    // Locale spelling: Ahaw (sources: MAYADECIPHERMENT_PERIOD_ENDINGS)
    // Alternatives:
  ...
  haabMonths: {
    ...
    // Month 4: sotz
    // Locale spelling: Sotz' (sources: MARTIN2012_PENN, MAYADECIPHERMENT_PERIOD_ENDINGS)
    // Alternatives:
    //   - Sots' (sources: ALDANA2022_EHOS)
    //   - Zotz' (sources: THOMPSON1950_MESOWEB, MAA_MAYATIMECYCLES_PDF)
    'Sotz\'': {
      canonical: 'Sotz\'',
      alternatives: ['Sots\'', 'Zotz\'']
    },
    // Month 5: tsek
    // Locale spelling: Tzek (sources: MAYADECIPHERMENT_PERIOD_ENDINGS, STUART2001_PARI_TXIX, MAA_MAYATIMECYCLES_PDF)
    // Alternatives:
    ...
    // Month 12: keh
    // Locale spelling: Keh (sources: ALDANA2022_EHOS, MARTIN2012_PENN, MAYADECIPHERMENT_PERIOD_ENDINGS, STUART_CH6_MESOWEB)
    // Alternatives:
