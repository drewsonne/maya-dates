...
export class I18nManager {
  ...
  /**
   * Register the default locale with canonical spellings from the enums.
   * The default locale is now a first-class locale like any other.
   */
  private registerDefaultLocale(): void {
    this.locales.set(DEFAULT_LOCALE, {
