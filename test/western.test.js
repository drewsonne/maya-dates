...
describe('long-count to gregorian/julian', () => {
  ...
  const dates = [
    ...
    ['11.18.3.9.18', '15/10/1582 CE*', '15/10/1582 CE*', 2299161, 1714878], // Julian to Gregorian Switch
    ['11.18.3.9.17', '4/10/1582 CE*', '4/10/1582 CE*', 2299160, 1714877], // Julian to Gregorian Switch
